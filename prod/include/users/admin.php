            ...
            <ul class="admin-nav">
                ...
                <li data-function="5">manage users</li>
            </ul>
            ...
            <section data-form="add-destination">
                ...
                <form action="update.php" method="post" class="wrap">
                    ...
                    <div class="c--2 center">
                        <h3>Video</h3>
                        <input id="video" name="video" type="text" data-input="video_id" placeholder="Video ID">
                    ...
                    <div class="wrap">
                        ...
                        <div class="c--2">
                            ...
                            <input id="exp_video_<?php echo $pos; ?>" name="exp_video_<?php echo $pos; ?>" type="text" data-input="video_id" placeholder="Video ID">
            ...
            <section data-form="update-destination">
                ...
                <form class="wrap" action="update.php" method="post">
                    ...
                    <div class="c--2 center">
                        <h3>Video</h3>
                        <input id="u_video_url" name="video" type="text" data-input="video_id" placeholder="Video ID">
                    ...
                    <div class="wrap">
                        ...
                        <div class="c--2">
                            ...
                            <input id="u_exp_video_<?php echo $pos; ?>" name="exp_video_<?php echo $pos; ?>" type="text" data-input="video_id" placeholder="Video ID">
            ...
            <section data-form="manage-user">
                ...
                <form data-form="manage-user" class="selector update">
                    <div class="drop-down">
                        <select name="select">
                            <option value="">-- --</option>
                            <?php
                ...
                <form action="update.php" method="post">
                    <input name="form_type" value="manage-user" style="display: none">
                    <input name="id" id="user_id" value="id" style="display: none">

                    <p class="selection"><span id="u_before"></span><span id="u_choice"></span><br><br><span id="u_date_join"></span></p>
                    ...
                    <input class="button-blue" id="submit" type="submit" value="submit">
                </form>
